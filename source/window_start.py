...
class StartWindow(wx.Frame):
    ...
    def __init__(self):
        wx.Frame.__init__(
            self, None, -1, 'Minecraft SoundReplacer v0.7b', size=(self.WIDTH, self.HEIGHT))
        ...
        self.button_folder_BE = wx.BitmapButton(
            self, -1, wx.Bitmap('./image/button_folder.png'), pos=(160, 15), size=(16, 16))
        self.button_folder_BE.SetBitmapPressed(
            wx.Bitmap('./image/button_folder_on.png'))
        self.button_folder_BE.SetBitmapFocus(
            wx.Bitmap('./image/button_folder_hover.png'))
        ...
        self.button_support = wx.BitmapButton(
            self, -1, wx.Bitmap('./image/button_door.png'), pos=(900, 15), size=(16, 16))

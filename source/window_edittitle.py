...
class EditTitleWindow(wx.Dialog):
    ...
    def __init__(self, sounddata_bgm, nowtitle):
        ...
        self.button_ok = wx.BitmapButton(
            self, -1, wx.Bitmap('./image/button_check.png'), pos=(190, 10), size=(16, 16))
        self.button_ok.SetBitmapPressed(
            wx.Bitmap('./image/button_check_on.png'))
        self.button_ok.SetBitmapCurrent(
            wx.Bitmap('./image/button_check_hover.png'))

...
class PackData(wx.Panel):
    ...
    def __init__(self, scrolledwindow, startwindow, data, pos_):
        wx.Panel.__init__(self, scrolledwindow, pos=pos_, size=(self.WIDTH, self.HEIGHT))
        ...
        self.button_edit = wx.BitmapButton(self, -1, wx.Bitmap('./image/button_pen.png'), pos=(self.HEIGHT + 10, 118), size=(16, 16))
        ...
        self.button_delete = wx.BitmapButton(self, -1, wx.Bitmap('./image/button_cancel.png'), pos=(self.HEIGHT + 40, 118), size=(16, 16))
    ...
    def click_edit(self, event):
        ...
        data_panelinput = [self.index, self.name, self.icon, self.description, self.header_uuid, self.modules_uuid, self.version, self.bundle]#20230209

...
class WindowBundle(wx.Dialog):
    ...
    def __init__(self, parent, bundle):
        ...
        self.button_remove = wx.BitmapButton(
            self.toolbar, -1, wx.Bitmap('./image/button_cancel.png'), pos=(55, 10), size=(16, 16))
        ...
        self.listbox = wx.ListBox(self.panel_bottom, -1, pos=(0, 0), size=(
            self.WIDTH-6, self.HEIGHT - self.TOOLBAR_HEIGHT-30), choices=bundle, style=wx.NO_BORDER)

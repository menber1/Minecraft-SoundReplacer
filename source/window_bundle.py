...
class WindowBundle(wx.Dialog):
    ...
    def __init__(self, parent, bundle):
        ...
        self.button_add = wx.BitmapButton(self.toolbar, -1, wx.Bitmap('./image/button_folderplus.png'), pos=(55, 10), size=(16, 16))
        ...
        self.button_remove = wx.BitmapButton(self.toolbar, -1, wx.Bitmap('./image/button_cancel.png'), pos=(90, 10), size=(16, 16))
        ...
        self.listbox = wx.ListBox(self.panel_bottom, -1, pos=(0, 0), size=(self.WIDTH-15, self.HEIGHT - self.TOOLBAR_HEIGHT-40), choices=bundle, style=wx.NO_BORDER | wx.VSCROLL | wx.HSCROLL)

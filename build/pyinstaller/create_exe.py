...
path_project = 'C:/...Path to project directory.../minecraft_soundreplacer/ffmpeg-7.0.1-essentials_build'
path_dist = './dist/minecraft_soundreplacer/ffmpeg-7.0.1-essentials_build'

shutil.copytree(path_project, path_dist)

path_project = 'C:/...Path to project directory.../minecraft_soundreplacer/Vanilla_Resource_Pack_1.21.0'
path_dist = './dist/minecraft_soundreplacer/Vanilla_Resource_Pack_1.21.0'

shutil.copytree(path_project, path_dist)

path_project = 'C:/...Path to project directory.../minecraft_soundreplacer/Vanilla_Resource_Pack_1.21_JE'
path_dist = './dist/minecraft_soundreplacer/Vanilla_Resource_Pack_1.21_JE'
